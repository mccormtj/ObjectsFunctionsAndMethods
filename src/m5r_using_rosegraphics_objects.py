...
#                Clone, attach_to, and move_by
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                Center, defaults, and fill_color
#
#     f. What does a RoseWindow RENDER method do?
#            Updates all shapes attached to RoseCanvas objects associated w/ this RoseWindow, then draws those shapes
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            This method keeps the window visible. Without anything keeping the program alive, the window would
#            immediately close and nothing would be seen
#
